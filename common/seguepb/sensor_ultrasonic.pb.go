...
func (UltraSonicQualifiers) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func (*SensorUltraSonicData) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{0} }
...
func init() { proto.RegisterFile("sensor_ultrasonic.proto", fileDescriptor3) }
